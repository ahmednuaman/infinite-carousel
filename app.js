...
(function() {
  ...
  Carousel = (function() {
    ...
    function Carousel(target) {
      this.data = new Data();
      this.maxIndex = config.numberOfItems - config.margin - 1;
      this.minIndex = config.margin;
      this.startPx = 0;
      this.endPx = (config.numberOfItems - 1) * config.width;
  ...
  Data = (function() {
    ...
    Data.prototype.dataAt = function(index) {
